...
_FAB_BINARY_ := $(SKIM_TOOLSDIR)/$(_FAB_NAME_)
# Path to the built binary, copied to ACI rootfs directory
_FAB_ACI_BINARY_ := $(SKIM_ACIROOTFSDIR)/$(_FAB_NAME_)
