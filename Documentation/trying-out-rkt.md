...
```
wget https://github.com/coreos/rkt/releases/download/v1.23.0/rkt-v1.23.0.tar.gz
tar xzvf rkt-v1.23.0.tar.gz
cd rkt-v1.23.0
./rkt help
```
...
<!-- BEGIN ANALYTICS --> [![Analytics](http://ga-beacon.prod.coreos.systems/UA-42684979-9/github.com/coreos/rkt/Documentation/trying-out-rkt.md?pixel)]() <!-- END ANALYTICS -->
