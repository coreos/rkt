...
# rkt --insecure-options=image run \
	...
	https://github.com/appc/spec/releases/download/v0.8.9/ace-validator-main.aci \
	https://github.com/appc/spec/releases/download/v0.8.9/ace-validator-sidekick.aci
```
