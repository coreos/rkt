...
image: using image from local store for image name coreos.com/rkt/stage1-coreos:1.27.0
...
rkt prepare coreos.com/etcd:v2.0.10
rkt: using image from local store for image name coreos.com/rkt/stage1-coreos:1.27.0
