...
CCN_IMG_RELEASE := 2219.99.0
# coreos image URL
CCN_IMG_URL := https://edge.release.flatcar-linux.net/$(RKT_STAGE1_COREOS_BOARD)/$(CCN_IMG_RELEASE)/flatcar_production_pxe_image.cpio.gz
