...
S1_RF_INSTALL_FILES += $(KERNEL_INITRD):$(KERNEL_ACI_INITRD):-
S1_RF_SECONDARY_STAMPS += $(KERNEL_STAMP)
CLEAN_FILES += $(KERNEL_TARGET_FILE)

$(call generate-stamp-rule,$(KERNEL_STAMP),$(KERNEL_ACI_INITRD) $(KERNEL_ACI_BZIMAGE) $(KERNEL_DEPS_STAMP) $(KERNEL_BUILD_CLEAN_STAMP) $(KERNEL_SRC_CLEAN_STAMP))
...
$(KERNEL_INITRD): $(KERNEL_INITRD_STAMP)
$(call generate-stamp-rule,$(KERNEL_INITRD_STAMP),$(KERNEL_BZIMAGE_STAMP),, \
	$(KERNEL_MAKEINITRD))
