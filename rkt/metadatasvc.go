...
func appGet(h func(w http.ResponseWriter, r *http.Request, c *container, am *schema.ImageManifest)) func(http.ResponseWriter, *http.Request) {
...
func handleAppAnnotations(w http.ResponseWriter, r *http.Request, c *container, am *schema.ImageManifest) {
	defer r.Body.Close()
...
func handleAppAnnotation(w http.ResponseWriter, r *http.Request, c *container, am *schema.ImageManifest) {
	defer r.Body.Close()
...
func handleImageManifest(w http.ResponseWriter, r *http.Request, c *container, am *schema.ImageManifest) {
	defer r.Body.Close()
...
func handleAppID(w http.ResponseWriter, r *http.Request, c *container, am *schema.ImageManifest) {
	defer r.Body.Close()
...
func runMetadataSvc(args []string) (exit int) {
	fmt.Println("Metadatasvc starting...")
	...
	fmt.Println("Metadatasvc running...")
	...
	cleanup(port)
	fmt.Println("Metadatasvc exiting...")
